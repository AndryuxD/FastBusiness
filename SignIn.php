                ...
                <div class="card border-success mb1-3" style="max-width: 25rem;">
                    ...
                    <div class="card-body">
                        <form action="Registro.php" method="post" >
                            ...
                            <input type="text" name="RFC" minlength="12" maxlength="12" class="form-control" placeholder="RFC de la empresa" required><br>
                            <input type="text" name="NomEmp" maxlength="50"  class="form-control" placeholder="Nombre de la empresa" required><br>
                            ...
                            <input type="checkbox" value="Si" name="Check" required> Acepto los terminos y condiciones del <a href="AboutUs.php">Aviso de privacidad</a>
                            <br><br>
