      ...
      <div class="container">
        ...
        <div class="portfolio-details-container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="owl-carousel portfolio-details-carousel">
            <img src="assets/img/portfolio/CarlosA.jpg" class="img-fluid" alt="">
            <img src="assets/img/portfolio/CarlosB.jpg" class="img-fluid" alt="">
            <img src="assets/img/portfolio/CarlosC.jpg" class="img-fluid" alt="">
          </div>

          <div class="portfolio-info">
            <h3>Informacion</h3>
            <ul>
              <li><strong>Invercionista</strong>: Carlos Bremer</li>
        ...
        <div class="portfolio-description">
          <h2>Carlos Bremer</h2>
          <p>
          Empresario, contador, regiomontano, filántropo, juez en Shark Tank y, de acuerdo a su propia descripción en redes sociales, soldado de la educación y el deporte de México. Él es Carlos Bremer. Nació el 1 de junio de 1960 en Monterrey, Nuevo León. Desde muy joven se vio involucrado en el empresariado mexicano, siendo invitado a trabajar para grupo Banpaís, en 1979. A los 25 años participó en la fundación de Ábaco Casa de Bolsa, sin embargo, quizá su proyecto más grande nació ocho años después, al lado del también regiomontano Javier Benítez Gómez, nos referimos a VALUE Grupo Financiero, un proyecto de intermediación bursátil que continúa hasta nuestros días.
          </p>
        </div>
